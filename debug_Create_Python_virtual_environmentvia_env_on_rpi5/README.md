...
step 3. test mini server ,connect to ha run ok ,can discovered by haon rpi5

https://github.com/mslycn/wyoming-funasr/blob/main/debug_Create_Python_virtual_environmentvia_env_on_rpi5/server3.py

step 4. test mini server ,connect to ha run ok ,can discovered ,load model by haon rpi5
